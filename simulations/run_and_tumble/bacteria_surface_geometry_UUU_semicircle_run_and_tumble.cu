...
//bacteria surface geometry, UUU boundary, semi-circle, run and tumble
  ...
  double delta_run, double delta_tumble, int kappa, int vMF_n)
{
  ...
  string headers("sim_num, case_num, dt, time_save, start_time, final_time, N, l, d, C, L, R, epsilon_r, sigma_bdy, inverse_Pe_T, inverse_Pe_parallel, inverse_Pe_perp, inverse_Pe_R, delta_run, delta_tumble, kappa, vMF_n");
